...
**Response**: No, becuase we have no data on salary in relation to education.
...
***Response**: Yes, it reasonably represents a bell shaped distribution.
...
**Response**:
```{r CI t test for mean number of edu years}
